...
<link rel="stylesheet"
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				账户管理 <small>修改密码</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/index.jsp"><i
						class="fa fa-dashboard"></i> 首页</a></li>
				<li><a href="${pageContext.request.contextPath}/songs/findAll.do">歌曲管理</a></li>
			...
			<form>
				...
				<div class="box-tools text-center">
					<button type="button" class="btn bg-maroon" onclick="updateFunction()">确定</button>
