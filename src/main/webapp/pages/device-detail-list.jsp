							...
							<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th class="sorting_desc">设备名称</th>
										<th class="sorting_desc">设备类型</th>
								...
								<tbody>
									...
									<c:forEach items="${pageInfo.list}" var="deviceDetails">
										<tr>
											<td><input name="ids" type="checkbox"></td>
											<td>${deviceDetails.id }</td>
											<td>${deviceDetails.name }</td>
											<td>${deviceDetails.deviceType.deviceType }</td>
...
<%--										<input id="edit_type_id" type="hidden" name="id">--%>
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li>
									<a href="${pageContext.request.contextPath}/deviceDetail/findAll.do?page=1&size=${pageInfo.pageSize}" aria-label="Previous">首页</a>
								</li>
								<li><a href="${pageContext.request.contextPath}/deviceDetail/findAll.do?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">上一页</a></li>
								<c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
									<li><a href="${pageContext.request.contextPath}/deviceDetail/findAll.do?page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a></li>
								</c:forEach>
								<li><a href="${pageContext.request.contextPath}/deviceDetail/findAll.do?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}">下一页</a></li>
								<li>
									<a href="${pageContext.request.contextPath}/deviceDetail/findAll.do?page=${pageInfo.pages}&size=${pageInfo.pageSize}" aria-label="Next">尾页</a>
								</li>
							</ul>
						</div>
		...
		<script>
			...
			function changePageSize() {
				...
				//向服务器发送请求，改变没页显示条数
				location.href = "${pageContext.request.contextPath}/songs/findAll.do?page=1&size="+pageSize;
